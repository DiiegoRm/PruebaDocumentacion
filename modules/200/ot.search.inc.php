...
switch($_REQUEST["mode"]){
 case 'show':
	...
	$r =  db_query("SELECT o.idestadoot,o.idcontrato,o.numero,o.fecha_solicitud,fecha_requerida,e.nombre estado,u.nombre creador,u.telefono,s.nombre segmento, o.iddepto, o.ideecc, o.idtipored 
		FROM ordenes o,estadoot e,usuarios u,segmentos s WHERE o.idestadoot > $OT_ST_ENCREACION AND o.id = $id AND o.idestadoot=e.id AND o.fecha_solicitud>='2017-03-01' 
		AND o.create_user=u.id AND o.idsegmento=s.id");
			...
			<div class="mainHeading"><h2>Ver Orden</h2></div>
				...
				<div id="tabs" style="display: none;">
					<ul>
						...
						<!-- DF - Adicion -->
						<li><a href="parts/ot/tab.adicion.ro.inc.php?id=<?php echo $id; ?>"><span>Adici&oacute;n</span></a></li>
					...
					<?php $id=decrypt(getVal(clean_input($_GET['id']),"0")); ?>
...
default:
	if (clean_input($_POST["enviado"])=='Boton'){
		$variable="";
	} else {
		$variable=" AND o.id='-1'";
	}
