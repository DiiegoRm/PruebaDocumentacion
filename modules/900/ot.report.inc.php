...
<div class="section">
	<div class="info">
	 <div class="outerbox">
		<div class="mainHeading"><h2>Lista de Reportes Ordenes</h2></div>
		<div class="actionbar">
			<?php printButtonBar(array("make"=>"makeReport('ordenes')")) ?>
		</div>
		<div>
...
<?php
		for($i=0,$j=0; $i<sizeof($files);$i++) {
			 if ($files[$i] != "." && $files[$i] != ".." && preg_match ('/^Ordenes_.*\.xml$/i',$files[$i])) {
