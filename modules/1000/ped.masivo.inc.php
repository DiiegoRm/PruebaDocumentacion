<div class="section">
	<div class="info">
	 <div class="formpage">
		<div class="outerbox">
			<div class="mainHeading"><h2>Importar/Exportar PEPS</h2></div>
			 <div class="messagebar">
            </div>
					<div style="padding-left: 10px;">
                        <form action="./export/peps.inc.php" method="post">
...
<script type="text/javascript" src="js/val/peps.masivo.js?ver=<?php echo SGP_VERSION?>"></script>