<div class="section">
	<div class="info">
	 <div class="formpage">
		<div class="outerbox">
			<div class="mainHeading"><h2>Importar/Exportar Usuario</h2></div>
			 <div class="messagebar">
                <span id="message" class="error"></span>
            </div>
					<div style="padding-left: 10px;">
                        <form action="./export/usuario.inc.php" method="post">
...
<script type="text/javascript" src="js/val/usuario.masivo.js?ver=<?php echo SGP_VERSION?>"></script>