<div class="section">
	<div class="info">
	 <div class="formpage">
		<div class="outerbox">
			<div class="mainHeading"><h2>Importar/Exportar Materiales</h2></div>
			 <div class="messagebar">
            </div>
					<div style="padding-left: 10px;">
                        <form action="./export/materialdetail.inc.php" method="post">
...
<script type="text/javascript" src="js/val/material.masivo.js?ver=<?php echo SGP_VERSION?>"></script>