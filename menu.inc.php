<div class="contentTopMenu">
		...
		<li class="menu_right"><a href="#" class="drop">Sesion</a>
			<div class="dropdown_1column align_right">
				<div class="col_1">
					<ul class="simple">
						<li>
							<h3><?php echo $appuser->login ?> (<?php echo $appuser->uid ?>)</h3>
						</li>
						<li>
							<h3><?php echo $appuser->nombre ?></h3>
						</li>
		...
		<?php if ($appuser->isInRole($CARGAR_PRESUPUESTO)) { ?>
			<li>
				...
				<div class='dropdown_2columns'>
					<div class='col_1'>
						<ul>
							<li><a href='?menu=101'><img src='./i/add.png' alt='' />Ingresar</a></li>
						</ul>
					</div>
					<div class='col_1'>
						<ul>
							<li><a href='?menu=102'><img src='./i/encreacion.png' alt='' />En Creacion</a></li>
						</ul>
					</div>
					<div class='col_1'>
						<ul>
							<li><a href='?menu=103'><img src='./i/search.png' alt='' />Consultar</a></li>
						</ul>
					</div>
				</div>
			</li>
			...
			<li>
				...
				<div class='dropdown_2columns'>
					<?php if ($appuser->isInRole($CREAR_CLUSTER)) { ?>
						<div class='col_1'>
							<ul>
								<li><a href='?menu=20001'><img src='./i/add.png' alt='' />Ingresar Cluster</a></li>
							</ul>
						</div>
						<div class='col_1'>
							<ul>
								<li><a href='?menu=20004'><img src='./i/tray.png' alt='' />Mi Bandeja</a></li>
							</ul>
						</div>
					<?php }
	...
	<div class='col_1'><ul><li><a href='?menu=20005'><img src='./i/tray.png' alt='' />Mi Bandeja S</a></li></ul></div>-->
					...
					<div class='col_1'>
						<ul>
							<li><a href='?menu=20003'><img src='./i/search.png' alt='' />Informe</a></li>
						</ul>
					</div>
				</div>
			</li>
			...
			<li>
				...
				<div class='dropdown_2columns'>
					<?php if ($appuser->isInRole("$GENERAR_OT_CAPEX,$GENERAR_OT_OPEX,$CARGAR_PRESUPUESTO")) { ?>
						<div class='col_1'>
							<ul>
								<li><a href='?menu=201'><img src='./i/encreacion.png' alt='' />En Creacion</a></li>
							</ul>
						</div>
					<?php }
					if ($appuser->isBtwRole($GESTIONAR_PEDIDOS, $FACTURA)) { ?>
						<div class='col_1'>
							<ul>
								<li><a href='?menu=202'><img src='./i/tray.png' alt='' />Mi Bandeja</a></li>
							</ul>
						</div>
					<?php }
					if ($appuser->isInRole($VER_REPORTES_OT)) { ?>
						<div class='col_1'>
							<ul>
								<li><a href='?menu=203'><img src='./i/search.png' alt='' />Consultar</a></li>
							</ul>
						</div>
					<?php } ?>
				</div>
			...
			<?php if ($appuser->isInGroup($GRP_EECC) || $appuser->isAdmin() || $appuser->isInRole($ADMINISTRACION) || $appuser->isInGroup($GRP_OP_ZONA_PE) || $appuser->isInGroup($GRP_OP_ZONA_PI)) { ?>
				<li>
					...
					<div class='dropdown_2columns'>
						<?php if ($appuser->isInRole("$GENERAR_OT_CAPEX,$GENERAR_OT_OPEX,$CARGAR_PRESUPUESTO")) { ?>
						<?php }
						if ($appuser->isInGroup($GRP_EECC) || $appuser->isAdmin() || $appuser->isInRole($ADMINISTRACION) || $appuser->isInGroup($GRP_OP_ZONA_PE) || $appuser->isInGroup($GRP_OP_ZONA_PI)) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=208'><img src='./i/tray.png' alt='' />Mi Bandeja</a></li>
								</ul>
							</div>
					</div>
			<?php
				...
				<?php if ($appuser->isInRole("$VER_CAUSACION,$LIQUIDAR_OT,$APROBAR_LIQUID,$APROBAR_RESERVAS,$CANCELAR_LIQUIDACION_SIN_CAUSAR,$ASIGNAR_QUITAR_MES_CAUSADO,$PEDIDO_Y_MIGO,$FACTURA")) { ?>
					<li>
						...
						<div class='dropdown_2columns'>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=301'><img src='./i/search.png' alt='' />Consultar</a></li>
								</ul>
							</div>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=302'><img src='./i/tray.png' alt='' />Mi Bandeja</a></li>
								</ul>
							</div>
						</div>
					</li>
				...
				if ($appuser->isInRole("$APROBAR_CLASE_H,$CARGAR_CLASE_H")) { ?>
					<li>
						...
						<div class='dropdown_2columns'>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=401'><img src='./i/search.png' alt='' />Consultar</a></li>
								</ul>
							</div>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=402'><img src='./i/tray.png' alt='' />Mi Bandeja</a></li>
								</ul>
							</div>
						</div>
					</li>
				...
				if ($appuser->isInRole($GESTIONAR_PEDIDOS)) { ?>
					<li>
						...
						<div class='dropdown_2columns'>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=501'><img src='./i/search.png' alt='' />Consultar</a></li>
								</ul>
							</div>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=502'><img src='./i/tray.png' alt='' />Mi Bandeja</a></li>
								</ul>
							</div>
						</div>
					</li>
				...
				<?php }
				if ($appuser->isInRole("$GENERAR_VB,$VER_REPORTES_VB,$ATENDER_VB")) { ?>
					<li>
						...
						<div class='dropdown_2columns'>
							<?php if ($appuser->isInRole($GENERAR_VB)) { ?>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=701'><img src='./i/add.png' alt='' />Ingresar</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=702'><img src='./i/encreacion.png' alt='' />En Creacion</a></li>
									</ul>
								</div>
							<?php }
							if ($appuser->isInRole($VER_REPORTES_VB)) { ?>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=703'><img src='./i/search.png' alt='' />Consultar</a></li>
									</ul>
								</div>
							<?php }
							if ($appuser->isInRole("$GENERAR_VB,$ATENDER_VB")) { ?>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=704'><img src='./i/tray.png' alt='' />Mi Bandeja</a></li>
									</ul>
								</div>
							<?php } ?>
						</div>
				...
				<li>
					...
					<div class='dropdown_2columns align_right'>
						<?php if ($appuser->isInRole($CARGAR_PRESUPUESTO)) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=901'><img src='./i/summary.png' alt='' />Resumen PP</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isInRole($CARGAR_PRESUPUESTO)) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=902'><img src='./i/trays.png' alt='' />Bandejas PP</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isInRole($VER_REPORTES_OT)) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=903'><img src='./i/summary.png' alt='' />Resumen OT</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isInRole($VER_REPORTES_OT)) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=904'><img src='./i/trays.png' alt='' />Bandejas OT</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isInRole($VER_REPORTES_VB)) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=905'><img src='./i/summary.png' alt='' />Resumen VB</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isInRole($VER_REPORTES_VB)) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=906'><img src='./i/trays.png' alt='' />Bandejas VB</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isInRole($VER_CAUSACION)) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=907'><img src='./i/summary.png' alt='' />Resumen CS</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isInRole($VER_CAUSACION)) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=908'><img src='./i/trays.png' alt='' />Bandejas CS</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isAdmin()) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=909'><img src='./i/report.png' alt='' />Reporte PPs</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isAdmin()) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=910'><img src='./i/report.png' alt='' />Reporte OTs</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isAdmin()) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=911'><img src='./i/report.png' alt='' />Reporte VBs</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isAdmin()) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=912'><img src='./i/report.png' alt='' />Reporte CSs</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isAdmin()) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=913'><img src='./i/report.png' alt='' />Reporte Sol.</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isAdmin()) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=914'><img src='./i/report.png' alt='' />Reporte Ped.</a></li>
								</ul>
							</div>
						<?php }
						if ($appuser->isAdmin()) { ?>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=915'><img src='./i/report.png' alt='' />Reporte Res.</a></li>
								</ul>
							</div>
						<?php } ?>
					</div>
				...
				<?php if ($appuser->isInRole("$ADMINISTRACION,$ASIGNAR_PM")  or $appuser->idgrupo == $ADMINISTRACIONPARCIAL) { ?>
					<li>
						...
						<div class='dropdown_2columns align_right'>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=1001'><img src='./i/settings.png' alt='' />Asignar PM a OT</a></li>
								</ul>
							</div>
							<?php if ($appuser->isInRole("$ADMINISTRACION,$CAMBIAR_PEP") or $appuser->idgrupo == $ADMINISTRACIONPARCIAL) { ?>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1010'><img src='./i/settings.png' alt='' />Cambiar Pep a OT</a></li>
									</ul>
								</div>
							<?php } ?>
							<?php if ($appuser->isInRole($ADMINISTRACION) or $appuser->idgrupo == $ADMINISTRACIONPARCIAL) { ?>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1002'><img src='./i/settings.png' alt='' />Cambiar VB a OT</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1003'><img src='./i/settings.png' alt='' />Cambiar Estado OT</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1004'><img src='./i/settings.png' alt='' />Cambiar Estado VB</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1005'><img src='./i/settings.png' alt='' />Cambiar Resp. OT</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1006'><img src='./i/settings.png' alt='' />Cambiar EECC a VB</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1007'><img src='./i/settings.png' alt='' />Corregir Pedidos</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1008'><img src='./i/settings.png' alt='' />Corregir Contrato OT</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1009'><img src='./i/settings.png' alt='' />Actualizar Pedidos</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1011'><img src='./i/settings.png' alt='' />Imp/Exp de PEPS</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1012'><img src='./i/settings.png' alt='' />Imp/Exp de Material</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1013'><img src='./i/settings.png' alt='' />Imp/Exp de Usuarios</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1014'><img src='./i/settings.png' alt='' />Imp/Exp de MatxAct</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1015'><img src='./i/settings.png' alt='' />Imp/Exp de IPC</a></li>
									</ul>
								</div>
								<div class='col_1'>
									<ul>
										<li><a href='?menu=1016'><img src='./i/settings.png' alt='' />Imp/Exp Cl. Baremo</a></li>
									</ul>
								</div>
							<?php } ?>
						</div>
				...
				if ($appuser->isInRole($ADMINISTRACION)) { ?>
					<li>
						...
						<div class='dropdown_2columns align_right'>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=9002'><img src='./i/roles.png' alt='' />Roles</a></li>
								</ul>
							</div>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=9003'><img src='./i/groups.png' alt='' />Grupos</a></li>
								</ul>
							</div>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=9004'><img src='./i/users.png' alt='' />Usuarios</a></li>
								</ul>
							</div>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=9005'><img src='./i/privileges.png' alt='' />Privilegios</a></li>
								</ul>
							</div>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=9006'><img src='./i/modules.png' alt='' />Backup/Restore</a></li>
								</ul>
							</div>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=9007'><img src='./i/preferences.png' alt='' />Preferencias</a></li>
								</ul>
							</div>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=9008'><img src='./i/pwdpolicy.png' alt='' />Politicas Seguridad</a></li>
								</ul>
							</div>
							<div class='col_1'>
								<ul>
									<li><a href='?menu=9009'><img src='./i/pwdpolicy.png' alt='' />Modificaion de Datos</a></li>
								</ul>
							</div>
						</div>
					</li>
