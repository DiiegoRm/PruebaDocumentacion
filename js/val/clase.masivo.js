$(function() {
    ...
    function formUploadAjax(handleData) {
        ...
        $.ajax({
            url: "callback/clase.inc.php?mode=import",
            type: "post",
            dataType: "html",
            async: false,
            data: formData,
    ...
    function formProcessAjax() {
      $.ajax({
          url: "callback/clase.inc.php?mode=process",
          type: "post",
          dataType: "html",
          async: false,
          cache: false,
          ...
          success: function(response) {
            ...
            if ((result.success.length > 0) || (result.errors.length > 0)) {  
              html += '<br/>Log: <a href="includes/descarga.inc.php?document=imp_clase.log&ruta=/data/files/log/&name=imp_clase.log">Click Aqui!</a>';
            } else {
