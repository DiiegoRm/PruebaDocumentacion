...
<table class="ui-widget ui-widget-content" style="width:100%">
	...
	while($row = mysqli_fetch_array($query)) {
		...
		echo "<td><a href=\"includes/descarga.inc.php?document=".htmlspecialchars(trim($row[archivo]))."&ruta=" . str_replace('/sgp', '', OT_FILE_WEB) . "&name=" . htmlspecialchars($row[titulo]). "\">".htmlspecialchars($row[titulo])."</a></td>\n";
		echo "<td>-</td>\n";
		echo "</tr>\n";
	}
	?>
