...
<div id="baremo">
	...
	<div>
		...
		<label class="formLabel" id="lbBaremo-<?php echo htmlspecialchars($row['id'])?>" for="txtBaremo-<?php echo htmlspecialchars($row['id'])?>">Actividad Baremo<span class="required">*</span></label>
		<select name="txtBaremo-<?php echo htmlspecialchars($row['id'])?>" id="txtBaremo-<?php echo htmlspecialchars($row['id'])?>" class="wideFormSelect" style="width:600px" tabindex="1">
		...
		<?php } ?>
		<br class="clear"/>
		<div id="table-baremos-1" class="ui-widget">
			<table id="actividades-<?php echo htmlspecialchars($row['id'])?>" class="ui-widget ui-widget-content">
				...
				<?php
					...
					WHERE a.idorden=$id AND a.version=$OT_VER_GENERADA AND a.idbaremo=b.id AND b.idclase={$row[id]}
...
<div id="table-baremos-2" class="ui-widget">
	...
	<table id="tactbar" class="ui-widget ui-widget-content">
		...
		<tbody>
			<?php
				...
				FROM actividadesxorden a, baremo b
				WHERE a.idorden=$id AND a.version=$OT_VER_GENERADA AND a.idbaremo=b.id
				GROUP BY b.id,b.item,b.descripcion,b.unidad,a.puntos,a.material ORDER BY b.item");
