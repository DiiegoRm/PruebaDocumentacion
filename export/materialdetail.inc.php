<?php 
  ...
  // Create new PHPExcel object
    ...
    $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('D1', 'UNIDAD')
                ->setCellValue('E1', 'VALOR')
                ->setCellValue('F1', 'FACTOR1')
                ->setCellValue('G1', 'FACTOR2')
                ->setCellValue('H1', 'FACTOR3')
          ->setCellValue('I1', ' ');

    // Cambiar el nombre de hoja de cálculo
    $objPHPExcel->getActiveSheet(0)->setTitle("Materiales");

    $tipo = "MODEM,TELEFONOS,ALAMBRE,CABLE,OTROS MATERIALES,TUBERIA";
